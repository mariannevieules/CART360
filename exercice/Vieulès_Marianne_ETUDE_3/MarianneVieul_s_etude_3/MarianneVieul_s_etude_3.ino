...
// max pressing time
const int MAX_PRESS_TIME = 10000;
...
int getPhotoFrequency()
{
 ...
 offsetFrequency = analogRead(PHOTO_PIN);
...
int rawSenseVal = analogRead(PHOTO_PIN);  runningAverageBuffer[nextCount] = rawSenseVal;  nextCount++; 
